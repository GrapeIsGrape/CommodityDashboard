...
- **Repository structure:**
  ...
  - `tests/` — pytest (`test_config.py`, `test_migrations.py`, `test_fred.py`, `test_eia.py`, `test_usda.py`, `test_cftc.py`, `test_iv.py`, `test_vol_indices.py`, `test_curve_shape.py` — live-Postgres-or-skip; external APIs/providers mocked)
