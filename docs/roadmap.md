...
| 5 — Polish & deploy | deploy Compose stack, release calendar, health checks/logging, redeploy docs | ▫️ not started — next phase (scheduler wiring also still deferred) |
