...
Open backlog: ~~**#8**~~ DONE · ~~**#12**~~ DONE · ~~**#13** (foundation + Panel D)~~ **DONE** · ~~**#14** (Panel C)~~ **DONE** · ~~**#15** (Panel A)~~ **DONE** · ~~**#16** (Panel A polish)~~ **DONE** · ~~**#18** (Panel B fundamentals/inventory)~~ **DONE**. Open: **#19** (Panel B Cushing tank-bottom proximity — nice-to-have follow-up, later cycle). Next: the prices-ETL→macro-sub-panel pair, or the deferred scheduler.
